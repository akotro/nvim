...
local options = {
	...
	mappings = {
		...
		r = {
			name = "+Replace",
			c = { ":.,$s@@gcI<left><left><left><left>", "Replace From Current Line" },
			n = { ":%s@@gI<left><left><left>", "Replace On Whole File (No Ask)" },
			a = { ":%s@@gcI<left><left><left><left>", "Replace On Whole File (Ask)" },
			w = { ":.,$s@<c-r><c-w>@@gcI<left><left><left><left>", "Replace Word On Cursor" },
		},
		-- Trouble
		x = {
			name = "+Trouble",
